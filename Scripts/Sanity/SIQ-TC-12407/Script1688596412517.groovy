...
not_run: WebUI.click(findTestObject('Object Repository/System User/Page_Lightning Experience  Salesforce/lightning-primitive-icon (1)'))
...
WebUI.waitForElementVisible(findTestObject('Object Repository/Delegate System/Page_SalesIQ Home  Salesforce/span_Quota Refinement'), 
    20)
